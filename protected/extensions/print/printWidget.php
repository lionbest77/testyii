 ...
 class printWidget extends CWidget
{
    ...
    */
    ...
    public function init()
    {
        ...
        echo CHtml::link("<img src=\"$imgUrl\" class=\"img_link\"> Печать", 
                    ...
                    if (firstTime) {
                        ...
                        for (var i=0; i<arrayEl.length; i++) {
                            ...
                            clonedEl.addClass('printWidgetPrintedElement');
														clonedEl.children('table').children('thead').children('tr').children('th').children('a').prop('href','');
														clonedEl.children('table').children('tbody').children('tr').children('.button-column').remove();
